...
<head>
    ...
    <title>Votre Arbre Genealogique</title>
...
<body style=" background-image: url(image/tree.jpg);
...
<div class="container-fluid" id="entete">
    ...
    <nav class="navbar navbar-inverse">
      ...
      <div class="container">
        ...
        <h4 class="gene">Voici votre Genealogie</h4>
      Pere
      <input type="text" name="pere" disabled value="<?php echo $_SESSION['infos']['Pere']; ?>">
      Mere
      <input type="text" name="mere" disabled value="<?php echo $_SESSION['infos']['mere']; ?>">
      <br> <br> <br>
        Conjoint(e)
      <input type="text" name="conjoint" disabled value="<?php echo $_SESSION['infos']['conjoint']; ?>" class="enfant_conjoint">

      <br> <br> <br>
      
    Enfant(s)
    <input type="text" name="enfant" disabled value="<?php echo $_SESSION['infos']['enfant']; ?>" class="enfant_conjoint">
